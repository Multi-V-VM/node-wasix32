...
function getDefaultTriggerAsyncId() {
  ...
  if (defaultTriggerAsyncId < 0) {
    const executionAsyncId = async_id_fields[kExecutionAsyncId];
    return executionAsyncId === undefined ? 0 : executionAsyncId;
  }
  if (defaultTriggerAsyncId === undefined)
    return 0;
...
function executionAsyncId() {
  const asyncId = async_id_fields[kExecutionAsyncId];
  return asyncId === undefined ? 0 : asyncId;
}
