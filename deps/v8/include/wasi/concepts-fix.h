...
// Base prelude defines this macro before including us to install polyfills
// safely. When this file is included from nested namespace contexts, the
// macro will be unset and we will not modify std::.
