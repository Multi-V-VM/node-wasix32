...
bool BackRefMatchesNoCase(Isolate* isolate, int from, int current, int len,
                          ZoneVector<const base::uc16> subject,
                          bool unicode) {
  Address offset_a =
...
bool BackRefMatchesNoCase(Isolate* isolate, int from, int current, int len,
                          ZoneVector<const uint8_t> subject, bool unicode) {
...
void UpdateCodeAndSubjectReferences(
    ...
    ZoneVector<const Char>* subject_string_vector_out) {
...
IrregexpInterpreter::Result RawMatch(
    ...
    Tagged<String>* subject_string, ZoneVector<const Char> subject,
