...
struct reducer_list_index_of : public ::v8::base::tmp::index_of1<RL, R, Otherwise> {};
...
struct reducer_list_insert_at : ::v8::base::tmp::insert_at1<RL, I, R> {};
...
struct reducer_list_to_stack
    : ::v8::base::tmp::fold_right1<::v8::base::tmp::instantiate, RL, Bottom> {};
...
struct next_reducer_is {
  static constexpr bool value =
      (::v8::base::tmp::is_instantiation_of<Next, Reducer>::value || ...);
};
...
struct next_contains_reducer<R<T>, Reducer> {
  static constexpr bool value = ::v8::base::tmp::equals1<R, Reducer>::value ||
