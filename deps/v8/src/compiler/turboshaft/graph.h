...
class Graph {
 public:
  ...
  void ReorderBlocks(ZoneVector<uint32_t> permutation) {
 ...
 private:
  ...
  V8_NOINLINE V8_PRESERVE_MOST void AllocateNewBlocks() {
    ...
    ZoneVector<Block> block_storage =
        graph_zone_->AllocateZoneVector<Block>(new_block_count);
    ZoneVector<Block*> new_all_blocks =
        graph_zone_->AllocateZoneVector<Block*>(next_capacity);
    ...
    ZoneVector<Block*> old_all_blocks = all_blocks_;
