...
class WasmGraphBuilder {
 public:
  ...
  Node* Return(ZoneVector<Node*> nodes);
 ...
 protected:
  ...
  Node* BuildCallNode(size_t param_count, ZoneVector<Node*> args,
                      wasm::WasmCodePosition position, Node* instance_node,
                      const Operator* op, Node* frame_state = nullptr);
  template <typename T>
  Node* BuildWasmCall(const Signature<T>* sig, ZoneVector<Node*> args,
                      ZoneVector<Node*> rets, wasm::WasmCodePosition position,
