...
double StringToDouble(ZoneVector<const uint8_t> str, ConversionFlag flag,
                      double empty_string_val = 0);
double StringToDouble(ZoneVector<const ::v8::base::uc16> str, ConversionFlag flag,
                      double empty_string_val = 0);
...
double V8_EXPORT_PRIVATE BinaryStringToDouble(ZoneVector<const uint8_t> str);

// Converts an octal string (of the form `0o[0-8]*`) into a double value
// according to https://tc39.es/ecma262/#sec-numericvalue
double V8_EXPORT_PRIVATE OctalStringToDouble(ZoneVector<const uint8_t> str);

// Converts a hex string (of the form `0x[0-9a-f]*`) into a double value
// according to https://tc39.es/ecma262/#sec-numericvalue
double V8_EXPORT_PRIVATE HexStringToDouble(ZoneVector<const uint8_t> str);
...
ImplicitOctalStringToDouble(ZoneVector<const uint8_t> str);
...
V8_EXPORT_PRIVATE std::string_view DoubleToStringView(
    double value, ZoneVector<char> buffer);
