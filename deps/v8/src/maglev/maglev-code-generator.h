...
class MaglevCodeGenerator final {
 public:
  ...
  GlobalHandleZoneVector<Map> RetainedMaps(Isolate* isolate);
 ...
 private:
  ...
  GlobalHandleZoneVector<Map> CollectRetainedMaps(DirectHandle<Code> code);
  ...
  GlobalHandleZoneVector<Map> retained_maps_;
