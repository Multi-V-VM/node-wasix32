...
static uint64_t ReadUInt64(::v8::base::Vector<const char> buffer, int from,
                           int digits_to_read) {
  uint64_t result = 0;
...
void Bignum::AssignDecimalString(::v8::base::Vector<const char> value) {
...
void Bignum::AssignHexString(::v8::base::Vector<const char> value) {
  Zero();
  int length = value.length();
