...
static void FillDigits32(uint32_t number, ::v8::base::Vector<char> buffer, int* length) {
  int number_length = 0;
...
static void FillDigits64(uint64_t number, ::v8::base::Vector<char> buffer, int* length) {
  const uint32_t kTen7 = 10000000;
  // For efficiency cut the number into 3 uint32_t parts, and print those.
  uint32_t part2 = static_cast<uint32_t>(number % kTen7);
  number /= kTen7;
...
static void DtoaRoundUp(::v8::base::Vector<char> buffer, int* length, int* decimal_point) {
...
static void FillFractionals(uint64_t fractionals, int exponent,
                            int fractional_count, ::v8::base::Vector<char> buffer,
...
static void TrimZeros(::v8::base::Vector<char> buffer, int* length, int* decimal_point) {
...
bool FastFixedDtoa(double v, int fractional_count, ::v8::base::Vector<char> buffer,
                   int* length, int* decimal_point) {
