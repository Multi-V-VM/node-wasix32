...
class ValueSerializer {
 ...
 private:
  ...
  void WriteOneByteString(ZoneVector<const uint8_t> chars);
  void WriteTwoByteString(ZoneVector<const base::uc16> chars);
...
class ValueDeserializer {
 public:
  ValueDeserializer(Isolate* isolate, ZoneVector<const uint8_t> data,
 ...
 private:
  ...
  Maybe<ZoneVector<const uint8_t>> ReadRawBytes(size_t size)
      V8_WARN_UNUSED_RESULT;
  Maybe<ZoneVector<const base::uc16>> ReadRawTwoBytes(size_t size)
      V8_WARN_UNUSED_RESULT;
