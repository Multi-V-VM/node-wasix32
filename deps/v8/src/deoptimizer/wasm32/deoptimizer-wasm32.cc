...
// Deoptimization exit sizes - minimal for WASM32 since deoptimization
// is not really used in the same way as native architectures
const int Deoptimizer::kEagerDeoptExitSize = 4;  // One instruction
const int Deoptimizer::kLazyDeoptExitSize = 4;   // One instruction
