...
class Utf8DecoderBase {
 public:
  ...
  void Decode(Char* out, ::v8::base::Vector<const uint8_t> data);

 protected:
  explicit Utf8DecoderBase(::v8::base::Vector<const uint8_t> data);
  Encoding encoding_;
...
class V8_EXPORT_PRIVATE Utf8Decoder final
 ...
 public:
  explicit Utf8Decoder(::v8::base::Vector<const uint8_t> data)
...
class Wtf8Decoder : public Utf8DecoderBase<Wtf8Decoder> {
 public:
  explicit Wtf8Decoder(::v8::base::Vector<const uint8_t> data)
      : Utf8DecoderBase(data) {}
...
class StrictUtf8Decoder : public Utf8DecoderBase<StrictUtf8Decoder> {
 public:
  explicit StrictUtf8Decoder(::v8::base::Vector<const uint8_t> data)
      : Utf8DecoderBase(data) {}
