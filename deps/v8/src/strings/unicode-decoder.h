...
class Utf8DecoderBase {
 public:
  ...
  void Decode(Char* out, ZoneVector<const uint8_t> data);

 protected:
  explicit Utf8DecoderBase(ZoneVector<const uint8_t> data);
  Encoding encoding_;
...
class V8_EXPORT_PRIVATE Utf8Decoder final
 ...
 public:
  explicit Utf8Decoder(ZoneVector<const uint8_t> data)
...
class Wtf8Decoder : public Utf8DecoderBase<Wtf8Decoder> {
 public:
  explicit Wtf8Decoder(ZoneVector<const uint8_t> data)
      : Utf8DecoderBase(data) {}
...
class StrictUtf8Decoder : public Utf8DecoderBase<StrictUtf8Decoder> {
 public:
  explicit StrictUtf8Decoder(ZoneVector<const uint8_t> data)
      : Utf8DecoderBase(data) {}
