...
template <class Decoder>
Utf8DecoderBase<Decoder>::Utf8DecoderBase(ZoneVector<const uint8_t> data)
...
#define DEFINE_UNICODE_DECODER(Decoder)                                 \
  ...
  template V8_EXPORT_PRIVATE void Utf8DecoderBase<Decoder>::Decode(     \
      uint8_t* out, ZoneVector<const uint8_t> data);                  \
  template V8_EXPORT_PRIVATE void Utf8DecoderBase<Decoder>::Decode(     \
      uint16_t* out, ZoneVector<const uint8_t> data)
