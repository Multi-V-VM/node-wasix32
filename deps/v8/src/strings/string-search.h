...
class StringSearchBase {
 protected:
  ...
  static inline bool IsOneByteString(::v8::base::Vector<const uint8_t> string) {
    return true;
  }

  static inline bool IsOneByteString(::v8::base::Vector<const base::uc16> string) {
...
class StringSearch : private StringSearchBase {
 public:
  StringSearch(Isolate* isolate, ::v8::base::Vector<const PatternChar> pattern)
      : isolate_(isolate),
        pattern_(pattern),
  ...
  int Search(::v8::base::Vector<const SubjectChar> subject, int index) {
 ...
 private:
  using SearchFunction = int (*)(StringSearch<PatternChar, SubjectChar>*,
                                 ::v8::base::Vector<const SubjectChar>, int);
  ...
  static int BoyerMooreHorspoolSearch(
      ...
      ::v8::base::Vector<const SubjectChar> subject, int start_index);
  ...
  ::v8::base::Vector<const PatternChar> pattern_;
...
template <typename PatternChar, typename SubjectChar>
inline int FindFirstCharacter(::v8::base::Vector<const PatternChar> pattern,
                              ::v8::base::Vector<const SubjectChar> subject,
                              int index) {
...
int StringSearch<PatternChar, SubjectChar>::SingleCharSearch(
    StringSearch<PatternChar, SubjectChar>* search,
    ::v8::base::Vector<const SubjectChar> subject, int index) {
...
int StringSearch<PatternChar, SubjectChar>::LinearSearch(
    StringSearch<PatternChar, SubjectChar>* search,
    ::v8::base::Vector<const SubjectChar> subject, int index) {
  ::v8::base::Vector<const PatternChar> pattern = search->pattern_;
...
int SearchString(Isolate* isolate, ::v8::base::Vector<const SubjectChar> subject,
                 ::v8::base::Vector<const PatternChar> pattern, int start_index) {
...
intptr_t SearchStringRaw(Isolate* isolate, const SubjectChar* subject_ptr,
  ...
  ::v8::base::Vector<const SubjectChar> subject(subject_ptr, subject_length);
  ::v8::base::Vector<const PatternChar> pattern(pattern_ptr, pattern_length);
