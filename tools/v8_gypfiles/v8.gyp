  ...
  'targets': [
    ...
    },  # v8_inspector_headers
    {
      ...
      'sources': [
        ...
        # WASM32 assembler sources - needed for WASI builds
      ...
      'conditions': [
        ...
        ['v8_target_arch=="wasm32" or (v8_target_arch=="ia32" and OS=="wasi")', {
          ...
          'sources!': [
            ...
            '<(V8_ROOT)/src/heap/cppgc/allocation.cc',
            '<(V8_ROOT)/src/heap/cppgc/caged-heap.cc',
            '<(V8_ROOT)/src/heap/cppgc/caged-heap-local-data.cc',
            '<(V8_ROOT)/src/heap/cppgc/compaction-worklists.cc',
            '<(V8_ROOT)/src/heap/cppgc/compactor.cc',
            '<(V8_ROOT)/src/heap/cppgc/concurrent-marker.cc',
            '<(V8_ROOT)/src/heap/cppgc/explicit-management.cc',
            '<(V8_ROOT)/src/heap/cppgc/free-list.cc',
            '<(V8_ROOT)/src/heap/cppgc/gc-info.cc',
            '<(V8_ROOT)/src/heap/cppgc/gc-info-table.cc',
            '<(V8_ROOT)/src/heap/cppgc/gc-invoker.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-base.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-consistency.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-growing.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-object-header.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-page.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-space.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-state.cc',
            '<(V8_ROOT)/src/heap/cppgc/heap-statistics-collector.cc',
            '<(V8_ROOT)/src/heap/cppgc/liveness-broker.cc',
            '<(V8_ROOT)/src/heap/cppgc/logging.cc',
            '<(V8_ROOT)/src/heap/cppgc/marker.cc',
            '<(V8_ROOT)/src/heap/cppgc/marking-state.cc',
            '<(V8_ROOT)/src/heap/cppgc/marking-verifier.cc',
            '<(V8_ROOT)/src/heap/cppgc/marking-visitor.cc',
            '<(V8_ROOT)/src/heap/cppgc/marking-worklists.cc',
            '<(V8_ROOT)/src/heap/cppgc/member-storage.cc',
            '<(V8_ROOT)/src/heap/cppgc/memory.cc',
            '<(V8_ROOT)/src/heap/cppgc/name-trait.cc',
            '<(V8_ROOT)/src/heap/cppgc/object-allocator.cc',
            '<(V8_ROOT)/src/heap/cppgc/object-size-trait.cc',
            '<(V8_ROOT)/src/heap/cppgc/page-memory.cc',
            '<(V8_ROOT)/src/heap/cppgc/persistent-node.cc',
            '<(V8_ROOT)/src/heap/cppgc/platform.cc',
            '<(V8_ROOT)/src/heap/cppgc/pointer-policies.cc',
            '<(V8_ROOT)/src/heap/cppgc/prefinalizer-handler.cc',
            '<(V8_ROOT)/src/heap/cppgc/process-heap.cc',
            '<(V8_ROOT)/src/heap/cppgc/process-heap-statistics.cc',
            '<(V8_ROOT)/src/heap/cppgc/raw-heap.cc',
            '<(V8_ROOT)/src/heap/cppgc/remembered-set.cc',
            '<(V8_ROOT)/src/heap/cppgc/stats-collector.cc',
            '<(V8_ROOT)/src/heap/cppgc/sweeper.cc',
            '<(V8_ROOT)/src/heap/cppgc/testing.cc',
            '<(V8_ROOT)/src/heap/cppgc/trace-trait.cc',
            '<(V8_ROOT)/src/heap/cppgc/virtual-memory.cc',
            '<(V8_ROOT)/src/heap/cppgc/visitor.cc',
            '<(V8_ROOT)/src/heap/cppgc/write-barrier.cc',
            # Exclude cppgc-js sources
            '<(V8_ROOT)/src/heap/cppgc-js/cpp-heap.cc',
            '<(V8_ROOT)/src/heap/cppgc-js/cpp-snapshot.cc',
            '<(V8_ROOT)/src/heap/cppgc-js/cross-heap-remembered-set.cc',
            '<(V8_ROOT)/src/heap/cppgc-js/unified-heap-marking-state.cc',
            '<(V8_ROOT)/src/heap/cppgc-js/unified-heap-marking-verifier.cc',
            '<(V8_ROOT)/src/heap/cppgc-js/unified-heap-marking-visitor.cc',
          ],
        }],
      ],
    },  # v8_base_without_compiler
