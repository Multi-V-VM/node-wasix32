      ...
      'conditions': [
        ...
        ['v8_target_arch=="wasm32"', {
          'sources!': [
            ...
            '<(V8_ROOT)/src/heap/cppgc/member.cc',
            '<(V8_ROOT)/src/heap/cppgc/memory.cc',
            '<(V8_ROOT)/src/heap/cppgc/metric-recorder.cc',
            '<(V8_ROOT)/src/heap/cppgc/object-allocator.cc',
            '<(V8_ROOT)/src/heap/cppgc/object-poisoner.cc',
            '<(V8_ROOT)/src/heap/cppgc/object-size-trait.cc',
            '<(V8_ROOT)/src/heap/cppgc/object-start-bitmap.cc',
